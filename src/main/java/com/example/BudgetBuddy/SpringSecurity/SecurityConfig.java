...
//                        .requestMatchers(HttpMethod.POST, "/departments", "/departments/**").permitAll() // Only ADMIN can create departments
                        ...
                        .requestMatchers(HttpMethod.GET, "/users","/organizations", "/organizations/**","/departments", "/departments/**", "/admin/**", "/notification/**", "/budgets/**", "/onetimeexpenses/**", "/recurringexpenses/**").permitAll()
